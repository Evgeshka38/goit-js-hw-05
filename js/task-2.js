...
console.log("🚀 ~ task:", "Start task-2.js");

function calcAverageCalories(days) {
  if (days.length === 0) {
    return 0;
  }
  let averageCaloriesDay = 0;
  for (const day of days) {
    averageCaloriesDay += day["calories"] / days.length;
  }
  return averageCaloriesDay;
}
...
console.log("🚀 ~ task:", "End task-2.js");
